...
import { AboutProjectVariants, AboutProjectVariantsLeft, MotionButton, MottionBtnVar } from '../animation/animation'
            ...
            <div className="mx-auto max-w-6xl container">
                <div className="flex justify-around inner">
                    <motion.div
                        ...
                        <p className="max-w-sm font-light text-2xl leading-7 about">With this service, users can create task lists, tasks in lists, which helps users to plan their tasks, and users can also form teams to complete tasks together </p>
                    </motion.div>
